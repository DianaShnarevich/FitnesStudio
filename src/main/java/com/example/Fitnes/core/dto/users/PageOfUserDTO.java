...
public class PageOfUserDTO {
    ...
    public PageOfUserDTO(int number, int size, int total_pages, int total_elements, boolean first, int number_of_elements, boolean last, UserDTO content) {
        this.number = number;
        this.size = size;
    ...
    public PageOfUserDTO(int number, int size, int total_pages, int total_elements, boolean first, int number_of_elements, boolean last) {
        this.number = number;
        this.size = size;
        this.total_pages = total_pages;
        this.total_elements = total_elements;
